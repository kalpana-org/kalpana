...
class MainWindow(QtGui.QFrame):
    ...
    def __init__(self, file_=''):
        ...
        # NaNoWidget
        self.nanowidget = NaNoWidget(self)
        topLayout.addWidget(self.nanowidget) #NOTE wots this topLayout then?!
...
#            pass 
#        self.myDay = 0 
#        self.nanowidget.nanoMode = False
#        self.nanoWidth = 20 
